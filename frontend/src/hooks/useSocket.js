...
export const useSocket = () => {
    ...
    const makeMove = useCallback(async (roomId, x, y) => {
        try {
    ...
    const watchRoom = useCallback(async (roomId, spectatorName) => {
        try {
    ...
    const closeRoom = useCallback(async (roomId, adminPassword) => {
        try {
    ...
    const restartGame = useCallback(async (roomId) => {
        try {
    ...
    const switchToSpectator = useCallback(async (roomId, playerName) => {
        try {
