    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          zIndex: 10000,
          background: 'linear-gradient(135deg, rgba(45, 27, 105, 0.85) 0%, rgba(76, 29, 149, 0.85) 100%)',
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* 左侧 - 播放视图（35%）*/}
        <div className="w-1/3 flex flex-col border-r border-white/10 overflow-y-auto" style={{
          background: 'linear-gradient(135deg, rgba(45, 27, 105, 0.5) 0%, rgba(76, 29, 149, 0.5) 100%)',
            ...
            {isLoading ? (
              ...
              <div className="text-center">
                <div className="w-32 h-32 mb-6 bg-white/10 rounded-2xl flex items-center justify-center">
                  <svg className="w-16 h-16 text-white/50 animate-spin" fill="none" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8 0 018 8 0 018-8 0 018 8 0 018-8z"></path>
                  </svg>
                </div>
                ...
                {playerViewMode === 'cover' ? (
                  <>
                    ...
                    <div className="text-center mb-8 flex-shrink-0">
                      <h2 className="text-2xl font-bold text-white mb-2 truncate px-2">{currentTrack.title}</h2>
                      <p className="text-gray-400 text-base truncate px-2">{currentTrack.artist}</p>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="text-center px-4">
                      <h2 className="text-2xl font-bold text-white mb-4 truncate px-2">{currentTrack.title}</h2>
                      <p className="text-gray-400 text-base mb-8 truncate px-2">{currentTrack.artist}</p>
        ...
        {/* 右侧 - 曲库视图（65%） */}
        <div className="w-2/3 flex flex-col overflow-hidden" style={{ 
          background: 'linear-gradient(135deg, rgba(76, 29, 149, 0.5) 0%, rgba(124, 58, 237, 0.5) 100%)',
          backdropFilter: 'blur(12px)'
        }}>
          {/* 曲库标签栏 - 居中显示 */}
          <div className="flex justify-center px-4 py-4 border-b border-white/10 flex-shrink-0">
